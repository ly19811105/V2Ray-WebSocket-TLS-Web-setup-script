...
root@ig-virtual-machine:/home/ig# vim beta.sh
root@ig-virtual-machine:/home/ig# vim test.sh
root@ig-virtual-machine:/home/ig# chmod 777 test.sh
root@ig-virtual-machine:/home/ig# ./test.sh
--2020-04-05 23:00:40--  https://github.com/openssl/openssl/archive/openssl-OpenSSL_1_1_1f.tar.gz
正在解析主机 github.com (github.com)... 52.74.223.119
正在连接 github.com (github.com)|52.74.223.119|:443... 已连接。
已发出 HTTP 请求，正在等待回应... 302 Found
位置：https://codeload.github.com/openssl/openssl/tar.gz/openssl-OpenSSL_1_1_1f [跟随至新的 URL]
--2020-04-05 23:00:42--  https://codeload.github.com/openssl/openssl/tar.gz/openssl-OpenSSL_1_1_1f
...
2020-04-05 23:01:50 错误 404：Not Found。

root@ig-virtual-machine:/home/ig# vim beta.sh
root@ig-virtual-machine:/home/ig# cat beta.sh
#!/bin/bash
nginx_version=nginx-1.17.9
openssl_version=openssl-OpenSSL_1_1_1f
